...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Alt Idle Animation', "(Note: This event is deprecated, but it still works. Use \"Screen Shake Amount\" instead.)\nSets a specified suffix after the idle animation name.\nYou can use this to trigger 'idle-alt' if you set\nValue 2 to -alt\n\nValue 1: Character to set (Dad, BF or GF)\nValue 2: New suffix (Leave it blank to disable)"],
		['Screen Shake Amount', "Value 1: Camera shake Amount\nValue 2: HUD shake Amount\nLeave them blank to reset them to 0."],
