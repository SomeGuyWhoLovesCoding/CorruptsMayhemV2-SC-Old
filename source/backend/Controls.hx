...
class Controls
{
	...
	//Mobile stuff
	public function buttonJustPressed(key:String, base:MobileGroup) {
		return base.buttons.get(key).justPressed;
	}
	public function buttonPressed(key:String, base:MobileGroup) {
		return base.buttons.get(key).pressed;
	}
	public function buttonJustReleased(key:String, base:MobileGroup) {
		return base.buttons.get(key).justReleased;
	}
