...
class ResetScoreSubState extends MusicBeatSubstate
{
	...
	override function create() {
		...
		add(mobileGrp);
		mobileGrp.buttons.get('accept').x = 300;
	}
	...
	override function update(elapsed:Float)
	{
		...
		if((controls.UI_LEFT_P || controls.buttonJustPressed('left', mobileGrp)) || (controls.UI_RIGHT_P || controls.buttonJustPressed('right', mobileGrp))) {
